...
from qgis.core import QgsProject, QgsApplication, QgsProcessingFeedback, QgsVectorLayer, QgsDataSourceUri
...
class QGisFoncier:
    ...
    def __init__(self, iface):
        ...
        self.dlg = QGisFoncierDialog ()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&QGIS Foncier')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QGisFoncier', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qgis_foncier/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'QGisFoncier'),
            callback=self.run,
